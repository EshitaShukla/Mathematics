...
bg1l=["gainsboro","grey","skyblue","#8313a6","orange","yellow","gainsboro","linen","dimgray","orange","silver"]
bg2l=["silver","dimgrey","midnightblue","#3056b3","orange","orange","gainsboro","linen","gainsboro","orange","lightgrey"]
fg3l=["dimgrey","dimgrey","midnightblue","#0976b3","orange","orange","dimgrey","brown", "grey","brown","black"]
Pl=["arc","black","blue","aquativo","kroc","radiance","keramik","clearlooks","plastik","kroc","plastik"]

theme="blue"
z=2
Px="/home/eshita/Desktop/Eshita/12th/computer/python/GUI/hw"
...
class P1(tk.Frame):                     # Home Page
    ...
    def __init__(self,parent,controller):
        ...
        #data=ttk.Button(self,text="Confidential information",command=lambda:controller.show_frame(P10))
        #data.pack()
...
class P10(tk.Frame):                       # Secret!!!
    def __init__(self,parent,controller):
        tk.Frame.__init__(self,parent)

        a_1=StringVar()
        l1=Label(self,text="Enter Password:",font="forte",fg=fg3,bg=bg3)
        l1.grid(row=1,column=0)
        ...
        def ceasar():
            ...
            for i in range(0,len(alphabet)):
                dic[alphabet[i]]=alphabet[(i+n)%len(alphabet)]

            
            ciphertext=""
            plaintext="This is confidential!!"
            l=''
            ...
            if ciphertext==plaintext.lower():
                l1=Label(self,text="You have successfully logged in: ",font="forte",fg=fg3,bg=bg3)
                l1.grid(row=6,column=1)
            else:
                l1=Label(self,text='''       Intruder!!!     
Look what I have for you!''',font="forte",fg=fg3,bg=bg3)
                l1.grid(row=6,column=1)
            l2=Label(self,text="Secrect message:"+ciphertext,font="forte",fg=fg3,bg=bg3)
            l2.grid(row=7,column=1)
    
            return ciphertext
            
        submit=ttk.Button(self,text="Submit",command=ceasar)
...
class P17(tk.Frame):         #solve equations              
    def __init__(self,parent,controller):
        ...
        rr=Label(self,text="Solve equation/s",font="forte",fg=fg3,bg=bg3)
        rr.pack()
...
class P18(tk.Frame):          #1 variable             
    def __init__(self,parent,controller):
        ...
        rr=Label(self,text="1 variable",font="forte",fg=fg3,bg=bg3)
        rr.pack()
...
class P19(tk.Frame):          # 1 variable 2 degree
    def __init__(self,parent,controller):
        ...
        rr=Label(self,text="2 degree equation with 1 variable (x)",font="forte",fg=fg3,bg=bg3)
...
class P20(tk.Frame):          # 1 variable 3 degree
    def __init__(self,parent,controller):
        ...
        rr=Label(self,text="3 degree equation with 1 variable (x)",font="forte",fg=fg3,bg=bg3)
        rr.grid(row=0,column=0)
        ...
        l1=Label(self,text="Expression",font="forte",fg=fg3,bg=bg3)
        l1.grid(row=1,column=0)

        Exp1=Entry(self,bd=10,textvariable=Exp_1)
        Exp1.grid(row=1,column=1,columnspan=2)

        l2=Label(self,text="Starting value",font="forte",fg=fg3,bg=bg3)
        l2.grid(row=2,column=0)

        a1=Entry(self,bd=10,textvariable=a_1)
        a1.grid(row=2,column=1,columnspan=2)

        l3=Label(self,text="Ending value",font="forte",fg=fg3,bg=bg3)
        l3.grid(row=3,column=0)

        b1=Entry(self,bd=10,textvariable=b_1)
        b1.grid(row=3,column=1,columnspan=2)

        '''l4=Label(self,text="Ending value",font="forte",fg="white",bg="black")
        l4.grid(row=3,column=0)

        c1=Entry(self,bd=10,textvariable=b_1)
        c1.grid(row=3,column=1,columnspan=2)

        l5=Label(self,text="Ending value",font="forte",fg="white",bg="black")
        l5.grid(row=3,column=0)

        d1=Entry(self,bd=10,textvariable=b_1)
        d1.grid(row=3,column=1,columnspan=2)'''
